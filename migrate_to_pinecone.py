...
# Configuration - get required data from the secret toml file
...
# Get all IDs first
# Read all 500,471 vectors from ChromaDB
...
for i in range(0, len(all_ids), BATCH_SIZE):
    ...
    # Convert numpy arrays to plain Python floats (Pinecone requires JSON-serializable)
    vectors_to_upsert = []
